            ...
            <div className="page-hero-grid">
              ...
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.75)", lineHeight: 1.75, maxWidth: "30rem", marginBottom: "2rem", fontSize: "1rem" }}>
                  Perspectives on Pan-African development, shared value, SME growth,
                  and the systems that shape the continent&apos;s future.
                </p>
              ...
              <div className="page-hero-photo">
                ...
                <div style={{ position: "relative", width: "100%", height: "100%", overflow: "hidden", borderRadius: "2px" }}>
                  <Image
                    src="https://res.cloudinary.com/dmyrmlj5z/image/upload/q_auto/f_auto/v1776127852/656160964_18357772666231283_2151060228362153169_n_xjbuaa.jpg"
                    alt="Andy writing and speaking"
                    fill
          ...
          {featured && (
            ...
            >
              ...
              <div style={{ position: "relative", height: "380px", background: "#152035" }}>
                {featured.thumb && (
                  <Image src={featured.thumb} alt={featured.title} fill style={{ objectFit: "cover" }} unoptimized />
                )}
              </div>
            </a>
          )}
