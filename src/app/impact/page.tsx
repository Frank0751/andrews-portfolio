...
const impactAreas = [
  {
    ...
    description: "Building the infrastructure for African entrepreneurship. From startup assessment frameworks to national investor networks, Andy has helped shape the systems that allow businesses to grow.",
    highlights: ["Tech startup maturity assessments across Ghana", "Connecting ventures to international accelerators", "Building national SME support frameworks"],
  },
  {
    icon: <MdHandshake size={32} />,
    title: "Creating Shared Value",
    description: "Embedding the philosophy into business operations and strategies that ensure business success and community prosperity are mutually reinforced. Profit with purpose.",
    highlights: ["Private sector engagement strategies", "Community benefit frameworks", "Stakeholder alignment programmes"],
  },
  {
    icon: <MdMic size={32} />,
    title: "Stage and Platform",
    description: "An engaging conference host and panel moderator facilitating critical conversations at summits across Africa and beyond. Known for turning panels into genuine conversations.",
    highlights: ["African Climate Summit, Nairobi", "EU-Africa SME Summit", "SVAI Annual Conference", "JamiiTrade Community Events"],
  },
  {
    icon: <RiGlobalLine size={32} />,
    title: "Intra-African Trade",
    description: "Championing a curated peer-to-peer community for SME trading in Africa, reducing barriers and expanding reach under the AfCFTA framework.",
    highlights: ["JamiiTrade focal point for Ghana", "SME onboarding and capacity building", "AfCFTA awareness and adoption"],
  },
  {
    icon: <MdLightbulb size={32} />,
    title: "Youth and SDGs",
    description: "Through UNLEASH, facilitating innovation labs that turn personal insights into sustainable development solutions. Bridging the gap between young people and systemic change.",
    highlights: ["UNLEASH Global Innovation Lab facilitator", "SDG-focused solution development", "Youth leadership programme design"],
  },
  {
    icon: <MdTrendingUp size={32} />,
    title: "Startup Growth",
    description: "Conducting tech startup maturity assessments across Ghana, connecting promising ventures to international programmes and building the next generation of African enterprises.",
    highlights: ["Ghana Climate Innovation Centre", "Startup assessment frameworks", "International programme linkages"],
  },
];
...
const highlights = [
  {
    title: "EU-Africa SME Summit",
    location: "Brussels, Belgium",
    year: "2025",
    description: "Represented Ghana's SME ecosystem at the EU-Africa SME Summit, facilitating dialogue between European and African business leaders on trade and investment opportunities.",
    image: "https://res.cloudinary.com/dmyrmlj5z/image/upload/q_auto/f_auto/v1776127496/568690701_18389482405130220_4097415862773396182_n_fpagkr.jpg",
  },
  {
    title: "African Climate Summit",
    location: "Nairobi, Kenya",
    year: "2023",
    description: "Participated in the first African Climate Summit, contributing to conversations on private sector engagement in Africa's climate response and green economy transition.",
    image: "https://res.cloudinary.com/dmyrmlj5z/image/upload/q_auto/f_auto/v1776127498/568403187_18389482339130220_7445678454955259057_n_tqzlwz.jpg",
  },
  {
    title: "UNLEASH Innovation Lab",
    location: "Shenzhen, China",
    year: "2018",
    description: "Facilitated an innovation lab bringing together 1,000 young leaders to develop solutions to the UN Sustainable Development Goals. A defining moment in Andy's approach to ecosystem building.",
    image: "https://res.cloudinary.com/dmyrmlj5z/image/upload/q_auto/f_auto/v1776127738/658877472_18584227099063671_8574493065532499635_n_zg28od.jpg",
  },
];
            ...
            <div className="page-hero-grid">
              ...
              <div>
                ...
                <p className="animate-fade-up delay-3" style={{ color: "rgba(255,255,255,0.75)", lineHeight: 1.75, maxWidth: "30rem", marginBottom: "2rem", fontSize: "1rem" }}>
                  ...
                  to Rabat. The work spans borders, sectors, and generations.
                </p>
              ...
              <div className="animate-fade-in delay-3 page-hero-photo">
                ...
                <div style={{ position: "relative", width: "100%", height: "100%", overflow: "hidden", borderRadius: "2px" }}>
                  <Image
                    src="https://res.cloudinary.com/dmyrmlj5z/image/upload/q_auto/f_auto/v1776127739/640444919_17976286100834819_9105085867200179719_n_zmqpet.jpg"
                    alt="Andy creating impact"
                    fill
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1.5rem" }}>
            {impactAreas.map((area, i) => (
              <Reveal key={i} delay={i * 0.08}>
                <div
                  style={{ background: "#ffffff", borderRadius: "16px", padding: "2rem", border: "1px solid rgba(0,0,0,0.08)", height: "100%", transition: "all 0.3s" }}
                ...
                <div style={{
                  ...
                  <div style={{ order: i % 2 === 0 ? 1 : 2 }}>
                    <div style={{ display: "flex", gap: "1rem", marginBottom: "1rem" }}>
                      <span style={{ background: "rgba(201,145,42,0.1)", color: "#C9912A", fontSize: "0.7rem", fontWeight: 700, padding: "0.3rem 0.8rem", borderRadius: "2rem", letterSpacing: "0.08em", textTransform: "uppercase" }}>{item.year}</span>
                      <span style={{ color: "#4a6070", fontSize: "0.82rem", display: "flex", alignItems: "center" }}>{item.location}</span>
                    </div>
